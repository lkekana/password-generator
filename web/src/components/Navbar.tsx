...
export function Navbar() {
	...
	return (
		<header className="w-full border-b-4 border-black bg-white px-4 md:px-8 py-4 flex items-center justify-between shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sticky top-0 z-50 box-border">
			<div className="flex items-center gap-2 md:gap-4">
			<Star13 className="w-12 h-12 md:w-16 md:h-16" />
			...
			<nav className="flex items-center gap-2 md:gap-4">
				...
				<Button asChild variant="neutral" className="content-center hidden md:inline">
					<a
